...
export function handleNewNaughtyLister(event: NewNaughtyLister): void {
  ...
  entity.naughtyLister = event.params.naughtyLister
  ...
  //
  // - contract.feeAmount(...)
  // - contract.getOwnerWithdrawableAmount(...)
  // - contract.getWithdrawableAmount(...)
  // - contract.naughtyList(...)
  // - contract.niceList(...)
  // - contract.numNiceListers(...)
  // - contract.totalFeesAccrued(...)
}
